    ...
    function productEditController(apiService, $scope, notificationService, $state, commonService, $stateParams) {
        ...
        function UpdateProduct() {
            ...
            apiService.put('api/product/update', $scope.product,
                function (result) {
                    notificationService.displaySuccess('Congratulations!!! '+result.data.Name+ ' has been update successfully!');
                    $state.go('products');
                }, function (error) {
                    notificationService.displayError('Opps!!! Update Product Unsuccessfully!');
                });
        }

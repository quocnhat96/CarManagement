    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.MenuGroups", t => t.MenuGroups_ID)
                .Index(t => t.MenuGroups_ID);
                ...
                c => new
                    {
                        ...
                        ValueCode = c.String(maxLength: 250),
                        ValueInt = c.Int(),
                    })
                .PrimaryKey(t => t.ID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Menus", "MenuGroups_ID", "dbo.MenuGroups");
            ...
            DropIndex("dbo.Menus", new[] { "MenuGroups_ID" });
